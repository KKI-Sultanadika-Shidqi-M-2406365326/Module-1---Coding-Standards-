...
sonar {
    properties {
        property("sonar.projectKey", "KKI-Sultanadika-Shidqi-M-2406365326_Module-1---Coding-Standards-")
        property("sonar.organization", "kki-sultanadika-shidqi-m-2406365326")
